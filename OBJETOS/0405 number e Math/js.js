...
/*
const a = parseFloat('99.50') // Mesma função sem o Number
Number.parseFloat('99.50') // 99.5
Number.parseFloat('100 Reais') // 100
Number.parseFloat('R$ 100') // NaN

const f = parseInt('99.50', 10) // 99
...
preco2.toFixed() // lembrando que o valor se torna uma STRING */
...
const teste = Math.floor(Math.random() * 34) + 32
