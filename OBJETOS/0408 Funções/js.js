...
descricaoCarro.call(carro) // Ford 2018 É MAIS COMUM CRIAR O OBJETO, IGUAL FOI FEITO
 */
...
// Utilizando métodos array em array-like

const filtro = Array.prototype.filter.call(li, function (e) {
...
const $ = document.querySelectorAll.bind(document) // mesma coisa que document.querySelectorAll(".li") */
...
const carro = {
  marca: 'Ford',
  ano: 2018,
  acelerar: function (aceleracao, tempo, dia) {
    return `${this.marca} acelerou ${aceleracao} em ${tempo} na ${dia} `
  }
}
...
const acelerarHonda = carro.acelerar.bind(honda) //precisa ter a chamada da função
acelerarHonda(200, 10, 'segunda')
//  Honda acelerou 200 em 10

// const acelerarHonda = carro.acelerar.call(honda, 150, 25, 'segunda') //EM CALL
*/
...
const imc180 = imc.bind(null, 75) // null, não tem referência a nhm objeto
